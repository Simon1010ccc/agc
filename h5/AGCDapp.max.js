...
//class com.cocoadd.manage.LevelDataScreen extends laya.display.Sprite
var LevelDataScreen=(function(_super){
	function LevelDataScreen(){
		this.levelT1=null;
		this.levelT2=null;
		this.levelT3=null;
		this.levelT4=null;
		...
		this.num6=NaN;
		this.i=0;
		LevelDataScreen.__super.call(this);
		LevelDataScreen.instance=this;
		this.size(Laya.stage.width,Laya.stage.height);
		this.init();
	}

	__class(LevelDataScreen,'com.cocoadd.manage.LevelDataScreen',_super);
	var __proto=LevelDataScreen.prototype;
	__proto.init=function(){
		var bgImg=new Image("hall/bg2.png");
		this.addChild(bgImg);
		var closeB=new MyButton("back",150,60,"#f1f1f1","#FEFEFE",32);
		this.addChild(closeB);
		closeB.x=this.width-closeB.width-30;
		closeB.y=20;
		closeB.on("click",this,this.closeBHandler);
		this.levelT1=new Text();
		this.levelT1.fontSize=28;
		this.levelT1.text="V1:0";
		this.levelT1.color="#A2A3BB";
		this.addChild(this.levelT1);
		this.levelT1.x=100;
		this.levelT1.y=170;
		this.levelT2=new Text();
		this.levelT2.fontSize=28;
		this.levelT2.text="V2:0";
		this.levelT2.color="#A2A3BB";
		this.addChild(this.levelT2);
		this.levelT2.x=100;
		this.levelT2.y=240;
		this.levelT3=new Text();
		this.levelT3.fontSize=28;
		this.levelT3.text="V3:0";
		this.levelT3.color="#A2A3BB";
		this.addChild(this.levelT3);
		this.levelT3.x=100;
		this.levelT3.y=310;
		this.levelT4=new Text();
		this.levelT4.fontSize=28;
		this.levelT4.text="V4:0";
		this.levelT4.color="#A2A3BB";
		this.addChild(this.levelT4);
		this.levelT4.x=100;
		this.levelT4.y=380;
		this.levelT5=new Text();
		this.levelT5.fontSize=28;
		this.levelT5.text="V5:0";
		this.levelT5.color="#A2A3BB";
		this.addChild(this.levelT5);
		this.levelT5.x=100;
		this.levelT5.y=450;
		this.levelT6=new Text();
		this.levelT6.fontSize=28;
		this.levelT6.text="V6:0";
		this.levelT6.color="#A2A3BB";
		this.addChild(this.levelT6);
		this.levelT6.x=100;
		this.levelT6.y=520;
		this.num1=0;
		this.num2=0;
		...
		this.num5=0;
		this.num6=0;
		getPlayerInfo(this,LevelDataScreen.instance.i);
	}

	// }
	__proto.getPlayerInfoSuccess=function(res){
		var level=Number(res[2]);
		switch(level){
			case 1:{
					this.num1++;
					this.levelT1.text="V1:"+this.num1;
					break ;
				}
			case 2:{
					this.num2++;
					this.levelT2.text="V2:"+this.num2;
					break ;
				}
			case 3:{
					this.num3++;
					this.levelT3.text="V3:"+this.num3;
					break ;
				}
			case 4:{
					this.num4++;
					this.levelT4.text="V4:"+this.num4;
					break ;
				}
			case 5:{
					this.num5++;
					this.levelT5.text="V5:"+this.num5;
					break ;
				}
			case 6:{
					this.num6++;
					this.levelT6.text="V6:"+this.num6;
					break ;
				}
			}
		com.cocoadd.manage.LevelDataScreen.instance.i++;
		getPlayerInfo(this,LevelDataScreen.instance.i);
		if(this.i>5000){
			MainScreen.instance.hideBusy();
			return;
	...
	LevelDataScreen.instance=null;
	return LevelDataScreen;
})(Sprite)
...
var ParentAddressCheckPanel=(function(_super){
	function ParentAddressCheckPanel(){
		...
		this.tip1T=new Text();
		this.tip1T.fontSize=24;
		this.tip1T.text="Please enter the invitation address:";
		this.tip1T.color="#A2A3BB";
		this.addChild(this.tip1T);
		...
		this.checkB=new MyButton("submit",650,88,"#f1f1f1","#FEFEFE",32);
		...
		this.cancelB=new MyButton("cancel",650,88,"#f1f1f1","#FEFEFE",32,"cancel");
...
var PledgeScreen=(function(_super){
	...
	__proto.init=function(){
		...
		this.checkB.on("click",this,this.checkBHandler);
		this.manageB=new MyButton("Manage",690,88,"#f1f1f1","#FF0000",32,"cancel");
		this.addChild(this.manageB);
		this.manageB.x=30;
		this.manageB.y=600;
		this.manageB.on("click",this,this.manageBHandler);
		this.manageB.visible=false;
		if(PlayerData.account.toLowerCase()=="0xa5f7Ce272192210a122AdF3D4d30dDa31c9d650B".toLowerCase()
			|| PlayerData.account.toLowerCase()=="0x5bB4678aE7C704a1196f1361391780A55d5365ba".toLowerCase()
		|| PlayerData.account.toLowerCase()=="0xBF88617473b83B9026451e3F981E4bE0c4c0df53".toLowerCase()){
		...
		this.levelInfo.invitURLT.text="Invite:\n http://www.agc-token.com/h5/index.html?p= \n"+PlayerData.account;
	...
	__proto.manageBHandler=function(){
		var levelDataScreen=new LevelDataScreen();
		this.addChild(levelDataScreen);
...
var MainScreen=(function(_super){
	...
	__proto.loopHnadler=function(){
		...
		if(this.busy1I.rotation==20000){
			this.hideBusy();
			this.showAlert("Something error\nPlease confirm that your wallet is logged and select the BSC。");
		}
	}
...
var PledgeOrderLuckLpPanel=(function(_super){
	...
	__proto.getPledgeOrderIdsSuccess=function(arr){
		...
		if(arr.length>0){
			...
			label.text="no record of pledge";
			label.color="#78798B";
			label.fontSize=28;
